...
using SisWebSalesMVC.Models.Enums;

namespace SisWebSalesMVC.Data
{
    public class SeedingService
    {
        private SisWebSalesMVCContext _context;

        public SeedingService(SisWebSalesMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bobhtebrown@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria.green1@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexgy@gmail.com", new DateTime(1988, 3, 24), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "mred@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donaldblue@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Black", "alexb@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
